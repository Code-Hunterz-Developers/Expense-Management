...
import { sumTypePkr, sumTypeAmount, txAmountPkr, MARKET_EXCHANGE_RATE_DEFAULT } from '@/lib/currency';
...
export async function ensureSeedData() {
  ...
  if (!settingsSnap.exists()) {
    await setDoc(settingsRef, { usd_to_pkr: MARKET_EXCHANGE_RATE_DEFAULT });
  }
}
...
export async function getSettingsDoc() {
  ...
  return snap.exists() ? snap.data() : { usd_to_pkr: MARKET_EXCHANGE_RATE_DEFAULT };
}
